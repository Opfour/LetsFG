...
AIRLINE_COUNTRIES: dict[str, set[str]] = {
    ...
    "ethiopian": {
        "ET", "DJ", "ER", "SO", "KE", "TZ", "UG", "RW", "BI", "SS",
        "SD", "ZA", "MZ", "MW", "ZM", "ZW", "NA", "BW", "MU", "SC",
        "MG", "KM", "NG", "GH", "CI", "SN", "ML", "BF", "GN", "SL",
        "LR", "TG", "BJ", "NE", "GM", "CM", "TD", "GA", "CG", "CD",
        "CF", "GQ", "AO", "EG", "SA", "AE", "QA", "BH", "KW", "OM",
        "IL", "JO", "LB", "IN", "BD", "PK", "LK", "CN", "HK", "JP",
        "KR", "TH", "MY", "SG", "ID", "PH", "VN", "AU", "GB", "FR",
        "DE", "IT", "ES", "NL", "BE", "AT", "SE", "NO", "DK", "FI",
        "CH", "IE", "PL", "CZ", "PT", "GR", "TR", "RU", "MT",
        "US", "CA", "BR", "AR",
    },
    "finnair": {
...
def get_relevant_connectors(
    ...
    _AGGREGATOR_KEYS = {
        ...
        "travelstart",
        "aviasales", "travix", "travelup", "lastminute", "byojet", "yatra", "easemytrip",
